...
<br>*fs.nr_open = 1048576*<br>Данное оганичение является жестким (аппаратным?) - hardlimit<br>vagrant@vagrant:~$ ulimit -aH |grep files<br>
open files                      (-n) 1048576<br>Его не позволяет достич мягкое ограничение (программное?) - softlimit<br>vagrant@vagrant:~$ ulimit -aS |grep files
