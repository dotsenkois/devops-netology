...
1. Подготовка                          Получение ТЗ от клиентов. (Заказчик, Менеджер)

1. Проектирование                Обозначение конечной точки разработки продукта. (Менеджер, Разработчики, девопс)

1. Дизайн. Выбор методов и средств реализации. (Менеджер, Разработчики, девопс)

1. Кодирование. Написание кода. (Разработчики)

1. Деплой. Интеграция со средой. (Девопс)

1. Тестирование. Проверка функционирования продукта в тестовой среде. (QA, Девопс)

1. Документирование(разработчик, Девопс)

1. Развертывание (Девопс)

1. Сопровождение                (разработчик, Девопс)

1. Повторить при появлении новых требований